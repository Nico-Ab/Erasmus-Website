-- CreateEnum
CREATE TYPE "public"."UserRole" AS ENUM ('STAFF', 'OFFICER', 'ADMIN');

-- CreateEnum
CREATE TYPE "public"."UserApprovalStatus" AS ENUM ('PENDING', 'APPROVED', 'REJECTED', 'DEACTIVATED');
...
CREATE TABLE "public"."User" (
    ...
    "status" "public"."UserApprovalStatus" NOT NULL DEFAULT 'PENDING',
